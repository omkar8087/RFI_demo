...
import com.ob.rfi.UpdateQuetionireScroll;
import com.ob.rfi.db.RfiDatabase;

public class UpdateAdaptorFfi extends BaseAdapter{
	...
	public UpdateAdaptorFfi(Activity context,String[] Q_id, String[] q_text, String coverage)
	{
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		//setting background colour
				...
				questionAnswerCursor = db.select("Answer", "answerFlag,ans_text",whereClause121, null, null, null, null);
				
				System.out.println("count in adaptor-------"+questionAnswerCursor.getCount());
				...
				if(questionAnswerCursor.moveToFirst()){
					...
					System.out.println("answer flag...."+questionAnswerCursor.getString(questionAnswerCursor.getColumnIndex("answerFlag")));
					...
					if(questionAnswerCursor.getString(questionAnswerCursor.getColumnIndex("answerFlag")).equalsIgnoreCase("1") &&
						...
						rowView.setBackgroundResource(R.drawable.list_item_back);
							...
							questionAnswerCursor.getString(questionAnswerCursor.getColumnIndex("ans_text")).equalsIgnoreCase("2")){
		...
		rowView.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent int1=new Intent(context,UpdateQuetionireScroll.class);
